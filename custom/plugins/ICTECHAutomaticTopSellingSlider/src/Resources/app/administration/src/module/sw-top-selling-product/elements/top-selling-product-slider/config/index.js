import template from './sw-cms-el-config-top-selling-product-slider.html.twig';
import './sw-cms-el-config-top-selling-product-slider.scss';
 ...
 * @package content
 */
Component.register('sw-cms-el-config-top-selling-product-slider', {
    template,
