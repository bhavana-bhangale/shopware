import template from './sw-cms-el-config-custom-text-image.html.twig';
// import './sw-cms-el-config-custom-text-image.scss';
 ...
 * @package content
 */
Component.register('sw-cms-el-config-custom-text-image', {
    template,
