import template from './sw-cms-el-config-custom-product-slider.html.twig';
import './sw-cms-el-config-custom-product-slider.scss';
 ...
 * @package content
 */
Component.register('sw-cms-el-config-custom-product-slider', {
    template,
    ...
    computed: {
        ...
        productAssignmentTypes() {
            return [{
                label: this.$tc('sw-cms-custom-product-slider.elements.productSlider.config.productAssignmentTypeOptions.manual'),
                value: 'static',
            }, {
                label: this.$tc('sw-cms-custom-product-slider.elements.productSlider.config.productAssignmentTypeOptions.productStream'),
        ...
        productStreamSortingOptions() {
            return [{
                label: this.$tc('sw-cms-custom-product-slider.elements.productSlider.config.productStreamSortingOptions.nameAsc'),
                value: 'name:ASC',
            }, {
                label: this.$tc('sw-cms-custom-product-slider.elements.productSlider.config.productStreamSortingOptions.nameDesc'),
                value: 'name:DESC',
            }, {
                label: this.$tc('sw-cms-custom-product-slider.elements.productSlider.config.productStreamSortingOptions.creationDateAsc'),
                value: 'createdAt:ASC',
            }, {
                label: this.$tc('sw-cms-custom-product-slider.elements.productSlider.config.productStreamSortingOptions.creationDateDesc'),
                value: 'createdAt:DESC',
            }, {
                label: this.$tc('sw-cms-custom-product-slider.elements.productSlider.config.productStreamSortingOptions.random'),
                value: 'random',
            }, {
                label: this.$tc('sw-cms-custom-product-slider.elements.productSlider.config.productStreamSortingOptions.priceAsc'),
                value: 'cheapestPrice:ASC',
            }, {
                label: this.$tc('sw-cms-custom-product-slider.elements.productSlider.config.productStreamSortingOptions.priceDesc'),
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('custom-product-slider');
