import template from './sw-cms-el-custom-product-slider.html.twig';
import './sw-cms-el-custom-product-slider.scss';
 ...
 * @package content
 */
Component.register('sw-cms-el-custom-product-slider', {
    template,
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('custom-product-slider');
        },
