import template from './sw-cms-el-top-selling-product-slider.html.twig';
import './sw-cms-el-top-selling-product-slider.scss';
 ...
 * @package content
 */
Component.register('sw-cms-el-top-selling-product-slider', {
    template,
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('top-selling-product-slider');
        },
