...
CREATE TABLE `swag_data_demo_translation` (
    ...
    CONSTRAINT `fk.swag_data_demo_translation.swag_data_demo_id` FOREIGN KEY (`swag_data_demo_id`) REFERENCES `swag_data_demo` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT `fk.swag_data_demo_translation.language_id` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;